<template>
  <el-card shadow="always" class="card">
    <template #header>
      <div class="card_head">
        <span style="font-size: 24px;color: rgba(67,69,190,0.85)">需求</span>
    ...
    <div class="card_item" v-for="item in cardSelectData">
      <div style="display: flex;margin-right: auto">
        <SvgIcons width="28px" height="24px" color="#ffffff" icon-class="require_menu"/>
      ...
      <p style="font-size: 15px">
        <el-tag style="font-size: 15px" effect="plain">
...
export default {
  components: {SvgIcons},
  computed:{
    ...mapState(useProjRequirementStore,['cardSelectData'])
  },
  data() {
    return {}
  },
  ...
  created() {
    projRequirementStore.getCardSelectData()
  }
}
</script>
